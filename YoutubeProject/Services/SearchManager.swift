...
class SearchManager {
    func performRequest(_ search: String, token: String = "", completion: @escaping (Result<SearchModel, YoutubeProjectError>) -> Void) {
    ...
    func parseSearchJSON(_ searchData: Data, completion: @escaping (Result<SearchModel, YoutubeProjectError>) -> Void) {
